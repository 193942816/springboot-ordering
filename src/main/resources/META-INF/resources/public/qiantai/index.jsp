...
<%@page import="com.example.meal_ordering_system.dao.NoticeMapper" %>
        ...
        <td align="left" valign="top">
                        ...
                        <div id='pdv_3606'
                            ...
                            <div id='spdv_3606' class='pdv_content'
                                ...
                                <div class="pdv_border"
                                     style="margin: 0; padding: 0; height: 100%; border: 0px solid; background:none;">
            ...
            <div style="float:right;margin-right:10px;display:none"> <a href="-1" style="line-height:25px;color:">更多</a> </div>
                                    ...
                                    <div style="padding: 0px">
                                        <link href="${pageContext.request.contextPath}/public/qiantai/css/dingcanall.css"
                                              rel="stylesheet"
                                              type="text/css"/>
                                        <script src="${pageContext.request.contextPath}/public/qiantai/js/dingcanall.js"
                                                                    ...
                                                                    <table>
                                                                        <tr>
                                                                            <td rowspan="5" class="bookPic"><img
                                                                                    ...
                                                                                    style="border: 1px solid #300;"/>
                                                                            </td>
                                                                            <td><span>菜名:</span></td>
                                                                            <td>
                                                                                <span><strong><%=menus.getName()%></strong></span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><span><strong
                                                                                    style="color: red;"><%=menus.getPrice1()%></strong></span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><span>配料:</span></td>
                                ...
                                <td valign="top">
                                    <div id='pdv_' class='pdv_class'
                                        ...
                                        <div id='spdv_3603' class='pdv_content'
                                            ...
                                            <div class="pdv_border"
                                                ...
                                                <div
                                                    ...
                                                    <div style="margin: 0px 3px; padding: 10px;" align="left">
                                                        <link href="${pageContext.request.contextPath}/public/qiantai/css/newslist_time2.css"
                                                              rel="stylesheet"
                                                              type="text/css"/>
                                                            ...
                                                            <c:forEach items="${notices}" var="notice">
                                                                <li class="newslist_time2">
                                                                    ...
                                                                    <a
                                                                            ...
                                                                            class="newslist_time2">${notice.name}</a>
                                                                </li>
                                                            </c:forEach>
                                                        </ul>
                                            ...
                                            <div
                                                    style="margin-top: -10px; height: 10px; line-height: 10px; background: url(images/bg.jpg) 0px -220px no-repeat">
                                                &nbsp;
                                            </div>
                                            <div
                                                    style="float: right; margin-top: -10px; width: 10px; height: 10px; line-height: 10px; background: url(images/bg.jpg) -890px -220px no-repeat">
                                                &nbsp;
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id='pdv_3614' class='pdv_class' title='我的餐车'
                                        ...
                                        <div id='spdv_3614' class='pdv_content'
                                            ...
                                            <div class="pdv_border"
                                                 style="margin: 0; padding: 0; height: 100%; border: 0px solid; background:none;">
                                                <div
                                                        style="height: 25px; margin: 1px; display: none; background:red;">
                                                    <div
                                                            style="float: left; margin-left: 12px; line-height: 25px; font-weight: bold; color:red">
                                                        我的餐车
                                                    </div>
                                                    <div
                                                            style="float: right; margin-right: 10px; display: none">
                                                        <a href="-1" style="line-height: 25px; color:red">更多</a>
                                                    </div>
                                                </div>
                                                <div style="padding: 0px">
                                                    <link href="${pageContext.request.contextPath}/public/qiantai/css/dingcanche.css"
                                                          rel="stylesheet"
                                                          type="text/css"/>
                                                    <script src="${pageContext.request.contextPath}/public/qiantai/js/dingcanall.js"
                                                            type="text/javascript"></script>
                                                    <script src="${pageContext.request.contextPath}/public/qiantai/js/dingcansubmit.js"
                                                            type="text/javascript"></script>
                                                    <div id="dingcanche">
                                                        <div id="dingcanche2">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center"><%=sc.getPrice()%>
                                                                    </td>
                                                                    <td align="center"><%=sc.getSums()%>
                                                                    </td>
                                                                    <td align="center"><a
                                                                            href="/orders/order_shoppingcardel?del=<%=i%>">取消</a>
                                                                    </td>
                                                                </tr>
                                                                <%
                                                                        }
                                                            ...
                                                            <div style="height: 24px; margin: 5px 3px 1px 3px;">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <font id="allnums" style="color: #ff0000;"><%=sum2%>
                                                                    </font>份
                                                                </div>
                                                                <div
                                                                        style="float: right; line-height: 24px; padding-right: 30px;">
                                                                    <font id="cpprice" style="color: #ff0000;"><%=sum1%>
                                                                    </font>元
                                                                </div>
                                                            </div>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0">
                                                                    <tr>
                                                                        ...
                                                                        <td align="center" width="40%"><a
                                                                                ...
                                                                                src="${pageContext.request.contextPath}/public/qiantai/images/canche_submit.gif"
                                                                                border="0"/></a></td>
                                                                        <td align="center" width="40%"><a
                                                                                href="/orders/order_addshoppingcartoOrder?remove=1"><img
                                                                                src="${pageContext.request.contextPath}/public/qiantai/images/quxiao2.gif"
                                                                                border="0"/></a></td>
                                                                    </tr>
                                                                </table>
                                    ...
                                    <div id='pdv_3613' class='pdv_class'
                                        ...
                                        <div id='spdv_3613' class='pdv_content'
                                            ...
                                            <div class="pdv_border"
                                                 style="margin: 0; padding: 0; height: 100%; border: 0px solid; background:none;">
                                                <div
                                                        style="height: 25px; margin: 1px; display: none; background:none;">
                                                    <div
                                                            style="float: left; margin-left: 12px; line-height: 25px; font-weight: bold; color:none">
                                                        本周菜单
                                                    </div>
                                                    <div
                                                            style="float: right; margin-right: 10px; display: none">
                                                ...
                                                <div style="padding: 0px">
                                                    <link href="${pageContext.request.contextPath}/public/qiantai/css/dingcanweekmenu.css"
                                                          rel="stylesheet"
                                                          type="text/css"/>
                                                                ...
                                                                <div class="dingcanweekmenuinfo" align="left">
                                                                    ...
                                                                    <li class="newslist_time2">
                                                                        ...
                                                                        <a
                                                                                ...
                                                                                class="newslist_time2"><%=menus1.getName()%>
                                                                        </a></li>
